...
const generateWordDocument = (cliente, advogado) => {
  // Criar o conteúdo HTML formatado para Word
  const content = `
...
// Componente React para usar a função
